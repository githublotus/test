...
def handle_empty():
    os.system("rm -rdf '{}'".format(os.path.join(RECYCLE_BIN_ROOT_DIR, '*')))
...
def print_help():
    ...
    print("  {} + ls      {}[path|./]{}      Execute 'ls' command for [path] in recycle bin.   EX: {}rcb ls   {}./data/ (Default: ./){}".format(GREEN,GRAY,RESET,GREEN,GRAY,RESET))
    print("  {} + path    {}[path|./]{}      Show path for [path] in recycle bin.              EX: {}rcb path {}./data/ (Default: ./){}".format(GREEN,GRAY,RESET,GREEN,GRAY,RESET))
    print("  {} + tree    {}[path|./]{}      Execute 'tree' command for [path] in recycle bin. EX: {}rcb tree {}./data/ (Default: ./){}".format(GREEN,GRAY,RESET,GREEN,GRAY,RESET))
    print("  {}=== [2] Del/Restore ==={}   ".format(BLUE_BG, RESET))
    print("  {} + delete  {}<path>{}         Move {}<path>{} to recycle bin.                       EX: {}rcb delete  {}./data/abc{}".format(BLUE,RED,RESET,RED,RESET,BLUE,RED,RESET))
    print("  {} + restore {}<path/'all'>{}   Restore {}<path>{} or {}'all'{} from current dir.         EX: {}rcb restore {}./data/abc{} ,EX: {}rcb restore {}all{}".format(BLUE,RED,RESET,RED,RESET,RED,RESET,BLUE,RED,RESET,BLUE,RED,RESET))
    print("  {} + clean   {}[path|./]{}      Remove all data from [path] in recycle bin.       EX: {}rcb clean   {}./data/abc (Default: ./){}".format(BLUE,GRAY,RESET,BLUE,GRAY,RESET))
